...
class Photographer
  ...
  def photographer_title
    ...
    if self.experience < 4
      return "the photographer #{self.name} is a begginer with #{self.experience} years of experience"
    elsif self.experience.between?(4,6)
      return "the photographer #{self.name} is a instagramer with #{self.experience} years of experience"
    elsif self.experience.between?(7,10)
      return "the photographer #{self.name} is a photomaster with #{self.experience} years of experience"
    else
